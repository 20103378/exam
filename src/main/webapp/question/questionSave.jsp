...
<div class="data_list">
	...
	<div class="data_content" >
		...
		<table width="90%" align="center">
			...
			<tr>
				<td>
					<input type="hidden" id="paperid" name="question.paper.id" value="${paperid}"/>
					<input type="hidden" id="questionId" name="questionId" value="${question.qid }"/>
					<input type="submit" class="btn btn-primary" value="添加试题"/>
				</td>
				<td>
					<button class="btn btn-primary" type="button" onclick="javascript:window.location='getDetailPaper?paperId=${paperid}&searchType=1'">查看试卷详情</button>

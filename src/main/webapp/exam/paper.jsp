...
<script type="text/javascript">
	...
	function checkForm() {
		var divArray = document.getElementsByName("typediv1");
		for (i = 0; i < divArray.length; i++) {
			divArray[i].style.display = "";
		}
			// document.getElementById("typediv1").style.display="";//隐藏
		// document.getElementById("typediv2").style.display="";//隐藏
	}
	var examTime=20*60; 
...
<div class="data_list">
	<div class="data_info">
		<%--<strong><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;考试卷：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font  style="font-weight: bold;">${paperName}</font></p></strong>--%>
		<strong><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;考试卷：<strong>${paperName}</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="data_content">
		...
		<c:forEach var="s" items="${squestionList }" varStatus="status">
			...
			<%--<strong name="hidden" >[&nbsp;答案&nbsp;]&nbsp;${s.answer }</strong><br/><br/>--%>
			<div name ="typediv1"  class="col-lg-3 col-sm-6"  style="display:none;">
				<strong name="hidden" >[&nbsp;答案&nbsp;]&nbsp;${s.answer }</strong><br/><br/>
			</div>
			<br/>
		</c:forEach>
		...
		<c:forEach var="m" items="${mquestionList }" varStatus="status">
			...
			<div name ="typediv1"  class="col-lg-3 col-sm-6"  style="display:none;">
				<strong name="hidden"  >[&nbsp;答案&nbsp;]&nbsp;${m.answer }</strong><br/><br/>
			</div>
			<br/>
		</c:forEach>
        <br>
		...
		<%--<button class="btn btn-primary" type="button" onclick="javascript:window.location='questionList'">返回</button>--%>
